    ...
    <div className="bg-white">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Skånsk Trädgårdsvision</span>
              <img
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            >
              Ring Annika <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </nav>
      ...
      <main>
        <div className="relative isolate pt-14">
          ...
          >
            <div
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-green-200 to-green-400 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
